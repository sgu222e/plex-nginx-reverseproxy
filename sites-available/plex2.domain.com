#Config for server 2
#domain: plex2.DOMAIN.COM   #Replace DOMAIN.com with your domain
...
server {
	...
	server_name plex2.DOMAIN.COM;	#Replace DOMAIN.com with your domain
	...
	ssl_certificate /etc/letsencrypt/live/plex2.DOMAIN.COM/fullchain.pem;	#Replace DOMAIN.com with your domain
	ssl_certificate_key /etc/letsencrypt/live/plex2.DOMAIN.COM/privkey.pem;	#Replace DOMAIN.com with your domain
	...
	ssl_trusted_certificate /etc/letsencrypt/live/plex2.DOMAIN.COM/chain.pem;	#Replace DOMAIN.com with your domain
	...
	proxy_buffering off;
        ...
        location / {
                proxy_pass http://plex_backend2;
        }

        #PlexPy forward for server 1
        location /plexpya {
                proxy_pass http://127.0.0..2:8183;		# Update with your plexpy server IP and port
                proxy_redirect http://127.0.0.2:8183 https://plex2.DOMAIN.COM/plexpya/;		# Update with your plexpy server IP and port, and replace DOMAIN.COm
        }
        #PlexPy forward for server 2
        location /plexpyb {
        proxy_pass http://127.0.0.3:8181;				# Update with your plexpy server IP and port
        proxy_redirect http://127.0.0.3:8181 https://plex2.DOMAIN.COM/plexpyb/;	# Update with your plexpy server IP and port, and replace DOMAIN.COM
        }
        #PlexRequests forward for Ombi
        location /request {
                proxy_pass http://127.0.0.4:3000;		# Update with your Ombi server IP and port
                proxy_redirect http://127.0.0.4:3000 https://plex2.DOMAIN.COM/request/;	# Update with your Ombi server IP and port, and replace DOMAIN.com. NOTE: /requests is reserved by Ombi
        }
